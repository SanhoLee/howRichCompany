...
eval("var nickName = document.getElementById(\"jsNickname\");\nvar formDiv = nickName.lastChild;\nvar form = formDiv.querySelector(\"form\");\nvar SHOWING_ON = \"showing\";\n\nvar handleSubmit = function handleSubmit(event) {\n  event.preventDefault;\n  var currentValue = input.value;\n  localStorage.setItem(\"nickname\", currentValue);\n};\n\nvar askForName = function askForName() {\n  form.classList.add(SHOWING_ON);\n  form.addEventListener(\"submit\", handleSubmit);\n};\n\nvar init = function init() {\n  askForName();\n  console.log(\"hello\");\n};\n\nif (form) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/greeting.js?");
